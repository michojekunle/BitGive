...
import { Bitcoin, ArrowLeft, Users, Target, CheckCircle } from "lucide-react"
...
export default function CharityDetail({ charity }: CharityDetailProps) {
  const percentage = Math.min(Math.round((charity.raised / charity.goal) * 100), 100)
        ...
        <Card className="overflow-hidden border-border/40 bg-card/50 backdrop-blur-sm">
          <div className="relative h-64 w-full md:h-80">
            ...
            <div className="absolute bottom-0 left-0 p-6">
              ...
              <p className="mt-2 max-w-2xl text-muted-foreground">{charity.description}</p>
            </div>
          </div>
        </Card>
      </motion.div>
            ...
            <CardContent className="p-6">
              <div className="space-y-6">
                <div>
                  ...
                  <p className="mt-2 text-muted-foreground">{charity.longDescription}</p>
                </div>
                ...
                <div className="rounded-lg border border-border/40 bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-sm p-4">
                  <div className="grid grid-cols-3 gap-4">
                    <div className="text-center">
                      ...
                      <div className="mt-2 text-lg font-bold">{charity.raised} RBTC</div>
                      <div className="text-xs text-muted-foreground">Raised of {charity.goal} RBTC</div>
                    </div>
                    <div className="text-center">
                      ...
                      <div className="mt-2 text-lg font-bold">{charity.donors}</div>
